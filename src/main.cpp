...
static const int64 nDiffChangeTarget = 60; 
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0ad6280cff3cc68b209ef97d4414a9adb976a9afefcb2829c5fceb37e7a83584");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1399728188;	//6 June 2014, 11:00AM (GTM+7)
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 674115;

        if (fTestNet)
        {
            block.nTime    = 1399728188;
            block.nNonce   = 674115;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x06920c237bccedeea4ffb3f5f67ee24e1600d49797ee723e78c6f8fd35ef9b06"));
