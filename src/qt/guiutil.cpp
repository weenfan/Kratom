...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("kratom://"))
    {
        uri.replace(0, 11, "kratom:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Kratom.lnk";
}
...
{
    return GetAutostartDir() / "kratom.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Kratom-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  kratom-qt [" + tr("command-line options") + "]                     " + "\n";
