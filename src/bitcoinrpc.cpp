...
{
    return GetBoolArg("-testnet", false) ? 19458 : 19451;
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: kratom-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        || weakPassword(mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use kratomd";
